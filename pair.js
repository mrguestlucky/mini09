...
const config = {
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://i.postimg.cc/nrK43bpq/Picsart-26-02-28-23-28-51-964.jpg',
        MENU: 'https://i.postimg.cc/Y0r8FCB5/Picsart-26-02-28-23-12-59-324.jpg',
        OWNER: 'https://i.postimg.cc/c4gZtx1M/Picsart-26-02-28-23-35-26-352.jpg',
        SONG: 'https://i.postimg.cc/Y0r8FCB5/Picsart-26-02-28-23-12-59-324.jpg',
        VIDEO: 'https://i.postimg.cc/Y0r8FCB5/Picsart-26-02-28-23-12-59-324.jpg'
    }
};
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://i.postimg.cc/Y0r8FCB5/Picsart-26-02-28-23-12-59-324.jpg');
        ...
        try {
            switch (command) {   
                ...
                case 'alive': {
                    ...
                    const title = '*ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ ᴀᴄᴛɪᴠᴇ!!❤*';
                    const content = `*ᴏᴡɴᴇʀ:ɪᴍᴀᴅ ᴀʟɪ*\n` +                                   `ʙᴏᴛ ᴏᴡɴᴇʀ :- *ɪᴍᴀᴅ ᴀʟɪ*\n` +
                                `*ʙᴏᴛ ɴᴀᴍᴇ :- ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ*\n` +
                                   `*ʙᴏᴛ ᴡᴇʙ ꜱɪᴛᴇ*\n` +
                                   `> *https://www.immumdbot.com/*`;
...
┗━━━━━━━━━━━━━━━━━━┛
   ...
   ⦁ *ʙᴏᴛ ᴏᴡɴᴇʀ*: ɪᴍᴀᴅ ᴀʟɪ
   ⦁ *ᴠᴇʀꜱɪᴏɴ*: ᴠ𝟸 ʙᴇᴛᴀ
   ⦁ *ᴘʟᴀᴛꜰᴏᴇᴍ*: ɪᴍᴍᴜ ᴍᴅ ᴘʀɪᴠᴀᴛᴇ ᴠᴘs | ᴜʙᴜɴᴛᴜ 22.04
...
//=======================================
                case 'ping': {     
                    ...
                    let ping = await socket.sendMessage(sender, { text: '*_Pinging to Immu md..._* 🐥' });
                ...
                case 'owner': {
                    const vcard = 'BEGIN:VCARD\n'
                        ...
                        + 'FN:JEPHTER TECH\n'
                        + 'ORG:JEPHTER TECH\n'
                        + 'TEL;type=CELL;type=VOICE;waid=923493114170\n'
                        + 'EMAIL: immumd@proton.me\n'
                        + 'END:VCARD';

                    await socket.sendMessage(sender, {
                        contacts: {
                            displayName: "IMMU MD OWNER",
                            contacts: [{ vcard }]
                        },
                        image: { url: config.BUTTON_IMAGES.OWNER },
                        caption: '*ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ*',
                        buttons: [
    ...
    const title = '*ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ ꜱʏꜱᴛᴇᴍ*';
    const content = `┏━━━━━━━━━━━━━━━━\n` +
    ...
    await socket.sendMessage(sender, {
        image: { url: "https://i.postimg.cc/Y0r8FCB5/Picsart-26-02-28-23-12-59-324.jpg" },
        caption: formatMessage(title, content, footer)
    });
    break;
                }
                ...
                case 'song': {
                    try {
                        ...
                        const titleText = '*ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ*';
                        const content = `┏━━━━━━━━━━━━━━━━\n` +
                            `┃📝 \`Title\` : ${video.title}\n` +
                            `┃📈 \`Views\` : ${video.views}\n` +
...
await socket.sendMessage(userJid, {
    ...
    caption: formatMessage(
        ...
        'ɪᴍᴍᴜ ᴍᴅ'
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'ɪᴍᴍᴜ ᴍᴅ ᴍɪɴɪ'}`);
                }
            }
        });
    } catch (error) {
